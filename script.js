...
function resolveEventId() {
    ...
    const defaultEventId = String(eventConfig.defaultEventId || 'marioroberto2027').trim() || 'marioroberto2027';
...
const GuestConfig = {
    ...
    invitadoDefault: { nombre: "Carlos Mendez", pases: 2, ninos: 0 },
    paramId: 'id'
};
...
function initRSVP() {
    ...
    const waUrl = 'https://wa.me/50236011737?text=' + text;
...
const translations = {
  es: {
    portada_kicker: "Acompáñanos a celebrar los 65 años de",
    portada_boton: "Abrir invitación",
    scroll_hint: "Desliza hacia abajo",
    names_text: "Sesenta y cinco años de historia, familia y momentos inolvidables. Hoy queremos celebrarlo junto a ti.",
    ...
    nuevo_texto: "Hoy celebramos 65 años de vida, recuerdos y cariño compartido. Una noche especial para brindar por Mario Roberto y por todo lo que ha construido a lo largo del camino.",
    nuevo_titulo: "Feliz cumpleaños 65",
    itinerary_title: "Itinerario",
    itinerary_item_1: "Recepción",
    itinerary_item_2: "",
    itinerary_item_3: "",
    itinerary_item_4: "",
    itinerary_item_5: "",
    itinerary_item_6: "",
    itinerary_item_7: "",
    evento1_titulo: "Recepción",
    evento1_lugar: "Charleston Antigua",
    ...
    gifts_text: "Tu presencia es el mejor regalo. Si deseas tener un detalle con Mario Roberto, contaremos con lluvia de sobres.",
    ...
    playlist_text: "Ayúdanos a crear la playlist perfecta para esta celebración. Agrega esa canción que no puede faltar.",
    btn_playlist: "Agregar canción",
    wishes_title: "Buenos Deseos",
    wishes_text: "Déjale un mensaje especial a Mario Roberto para guardar este recuerdo por siempre.",
    ...
    wa_si: "Hola. Soy {nombre} y confirmo mi asistencia al cumpleaños 65 de Mario Roberto el 2 de agosto. Asistiré con {pases} {pases_label}.",
    wa_no: "Hola. Soy {nombre} y lamentablemente no podré asistir al cumpleaños 65 de Mario Roberto el 2 de agosto.",
    calendar_url: "https://calendar.google.com/calendar/render?action=TEMPLATE&text=Recepci%C3%B3n%20Cumplea%C3%B1os%2065%20Mario%20Roberto&dates=20270802T200000/20270803T010000&ctz=America%2FGuatemala&details=Celebraci%C3%B3n%20de%20cumplea%C3%B1os%2065%20de%20Mario%20Roberto&location=Charleston%20Antigua%2C%206a%20Avenida%20Norte%201%2C%20Antigua%20Guatemala",
    frase_final: "Hoy celebramos la vida de Mario Roberto, sus 65 años de historias, cariño y momentos inolvidables. Gracias por ser parte de esta noche tan especial.",
  },
  ...
  en: {
    ...
    names_text: "Sixty-five years of memories, family, and meaningful moments. Today, we celebrate Mario Roberto together with you.",
    ...
    nuevo_texto: "Today we celebrate 65 years of life, memories, and shared joy. A special evening to honor Mario Roberto and everything he has built along the way.",
    nuevo_titulo: "Happy 65th Birthday",
    itinerary_title: "Schedule",
    itinerary_item_1: "Reception",
    itinerary_item_2: "",
    itinerary_item_3: "",
    itinerary_item_4: "",
    itinerary_item_5: "",
    ...
    gifts_text: "Your presence is the greatest gift. If you wish to offer Mario Roberto a personal gesture, there will be an envelope shower.",
    ...
    playlist_title: "Playlist",
    playlist_text: "Help us build the perfect playlist for this celebration. Add the song that simply has to be there.",
    btn_playlist: "Add a song",
    wishes_title: "Best Wishes",
    wishes_text: "Leave Mario Roberto a special message to preserve this memory forever.",
    ...
    wa_si: "Hi. This is {nombre}, and I'm happy to confirm my attendance at Mario Roberto's 65th birthday on August 2nd. I'll be attending with {pases} {pases_label}.",
    wa_no: "Hi. This is {nombre}, and unfortunately I won't be able to attend Mario Roberto's 65th birthday on August 2nd.",
    calendar_url: "https://calendar.google.com/calendar/render?action=TEMPLATE&text=Reception%20Mario%20Roberto%2065th%20Birthday&dates=20270802T200000/20270803T010000&ctz=America%2FGuatemala&details=Mario%20Roberto%2065th%20birthday%20celebration&location=Charleston%20Antigua%2C%206a%20Avenida%20Norte%201%2C%20Antigua%20Guatemala",
    frase_final: "Tonight we celebrate Mario Roberto, his 65 years of memories, warmth, and unforgettable moments. Thank you for being part of this special evening.",
  }
};
